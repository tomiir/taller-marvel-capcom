...
#include "CaptainAmericaGrabLeftAnimation.h"
#include <SDL_timer.h>



void CaptainAmericaGrabLeftAnimation::init() {
...
CaptainAmericaGrabLeftAnimation::CaptainAmericaGrabLeftAnimation() : Animation() {
